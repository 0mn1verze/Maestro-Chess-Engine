...
def parse_score(mg_table, eg_table):
    for i in range(8):
        print(", ".join(
            f"_S({mg_table[(7-i)*8+j]:<3},{eg_table[(7-i)*8+j]:<3})" for j in range(8)), end=", ")
        print()
...
for mg_table, eg_table in pairs:
    parse_score(mg_table, eg_table)
    print("},\n{")
